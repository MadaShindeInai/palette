...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _controlls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controlls */ \"./src/js/controlls.js\");\n/* harmony import */ var _onloadFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./onloadFunctions */ \"./src/js/onloadFunctions.js\");\n/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canvas */ \"./src/js/canvas.js\");\n/* harmony import */ var _unsplashAPI__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./unsplashAPI */ \"./src/js/unsplashAPI.js\");\n/* eslint-disable no-param-reassign */\n\n\n\n\nconst canvas = document.querySelector('canvas');\nconst ctx = canvas.getContext('2d'); // get canvas\n\ncanvas.width = 512;\ncanvas.height = 512;\nconst img = new Image();\nconst flags = {\n  paintBucket: false,\n  chooseColor: false,\n  pencil: true,\n  transform: false,\n  pixelVal: 4,\n  isDrawing: false,\n  canvas128: true,\n  canvas256: false,\n  canvas512: false,\n  currColorVal: '#00ff00',\n  prevColorVal: '#ffeb3b',\n  tempColorVal: '#ffffff'\n};\n\nwindow.onload = () => {\n  Object(_onloadFunctions__WEBPACK_IMPORTED_MODULE_1__[\"updateObjInfo\"])(flags);\n  Object(_onloadFunctions__WEBPACK_IMPORTED_MODULE_1__[\"setDefaultCursor\"])(flags);\n  Object(_onloadFunctions__WEBPACK_IMPORTED_MODULE_1__[\"demoGrid\"])(flags);\n  Object(_onloadFunctions__WEBPACK_IMPORTED_MODULE_1__[\"drawRememberedPicture\"])(img); // В будущем необходимо сделать авторизацию. В этом таске из-за недостатка знаний ее реализовать\n  //  не получилось,но, по словам коллег я был на правильном пути, поэтому этот код я оставляю.\n  // if (window.location.search.indexOf('code')) {\n  //   fetch('https://github.com/login/oauth/access_token',\n  //     {\n  //       method: 'POST',\n  //       headers: {\n  //         'Access-Control-Allow-Origin': '*',\n  //         'Access-Control-Allow-Credentials': true,\n  //         'Content-Type': 'application/json',\n  //         Accept: 'application/json',\n  //       },\n  //       body: JSON.stringify({\n  //         client_id: 'f476cbe1146b74def3b4',\n  //         client_secret: '2ab9d65b5ccaf0b317d393d1614d000c34ace426',\n  //         code: window.location.search.substring(6),\n  //       }),\n  //     })\n  //     .then((response) => response.json())\n  //     .then((respJSON) => {\n  //       const result = respJSON.access_token;\n  //       console.log(result);\n  //     })\n  //     .catch((e) => console.log(e));\n  // }\n};\n\nObject(_controlls__WEBPACK_IMPORTED_MODULE_0__[\"setParamsOnRightControlPanel\"])(flags);\nObject(_controlls__WEBPACK_IMPORTED_MODULE_0__[\"chooseNewColor\"])(flags, ctx);\nObject(_controlls__WEBPACK_IMPORTED_MODULE_0__[\"setParamsOnControlPanel\"])(flags, ctx);\nObject(_controlls__WEBPACK_IMPORTED_MODULE_0__[\"setParamsOnRightControlPanel\"])(flags);\nObject(_canvas__WEBPACK_IMPORTED_MODULE_2__[\"paintCanvas\"])(flags);\nObject(_controlls__WEBPACK_IMPORTED_MODULE_0__[\"pushHotkeys\"])(flags);\nObject(_unsplashAPI__WEBPACK_IMPORTED_MODULE_3__[\"getImgFromUnsplash\"])(img, ctx, canvas);\nObject(_unsplashAPI__WEBPACK_IMPORTED_MODULE_3__[\"makeCanvasGray\"])(img, ctx, canvas);\n\nwindow.onbeforeunload = () => {\n  localStorage.setItem('tempObjVal', JSON.stringify(flags));\n  localStorage.setItem('dataUrl', canvas.toDataURL());\n};\n\n//# sourceURL=webpack:///./src/js/main.js?");

/***/ }),

/***/ "./src/js/onloadFunctions.js":
/*!***********************************!*\
  !*** ./src/js/onloadFunctions.js ***!
  \***********************************/
/*! exports provided: setDefaultCursor, demoGrid, updateObjInfo, drawRememberedPicture */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setDefaultCursor\", function() { return setDefaultCursor; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"demoGrid\", function() { return demoGrid; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateObjInfo\", function() { return updateObjInfo; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"drawRememberedPicture\", function() { return drawRememberedPicture; });\n/* eslint-disable no-param-reassign */\nconst canvas = document.querySelector('canvas');\nconst ctx = canvas.getContext('2d');\nconst currColorDiv = document.querySelector('.color-block__circle-curr');\nconst prevColor = document.getElementById('prevColor');\nlet tempObj;\nfunction setDefaultCursor(flags) {\n  if (flags.pencil) {\n    canvas.classList.add('pencilCursor');\n  }\n\n  if (flags.chooseColor) {\n    canvas.classList.add('pippeteCursor');\n  }\n\n  if (flags.paintBucket) {\n    canvas.classList.add('bucketCursor');\n  }\n}\nfunction demoGrid(flags) {\n  for (let j = 0; j < canvas.width / flags.pixelVal; j += 1) {\n    for (let i = 0; i < canvas.width / flags.pixelVal; i += 1) {\n      if ((j * (canvas.width / flags.pixelVal) + i + j) % 2 === 0) {\n        ctx.fillStyle = '#66CC66';\n        ctx.fillRect(j * flags.pixelVal, i * flags.pixelVal, flags.pixelVal, flags.pixelVal);\n      }\n    }\n  }\n} // REWRITE FLAGS\n\nfunction updateObjInfo(flags) {\n  tempObj = JSON.parse(localStorage.getItem('tempObjVal'));\n\n  if (localStorage.getItem('tempObjVal') === null) {\n    document.querySelector('div .pencil').classList.add('active');\n    document.querySelector('.canvas128').classList.add('active');\n    canvas.classList.add('pencilCursor');\n  }\n\n  for (const key in flags) {\n    if (Object.prototype.hasOwnProperty.call(flags, key)) {\n      flags[key] = tempObj[key];\n    }\n\n    if (typeof flags[key] === 'boolean' && flags[key] === true && flags[key] !== 'isDrawing') {\n      document.querySelector(`.${key}`).classList.add('active');\n    }\n  }\n\n  currColorDiv.style.backgroundColor = flags.currColorVal;\n  prevColor.style.backgroundColor = flags.prevColorVal;\n}\nfunction drawRememberedPicture(img) {\n  if (localStorage.getItem('dataUrl')) {\n    img.src = localStorage.getItem('dataUrl');\n\n    img.onload = () => {\n      ctx.drawImage(img, 0, 0, canvas.width, canvas.height);\n    };\n  }\n}\n\n//# sourceURL=webpack:///./src/js/onloadFunctions.js?");

/***/ }),

/***/ "./src/js/unsplashAPI.js":
/*!*******************************!*\
  !*** ./src/js/unsplashAPI.js ***!
  \*******************************/
/*! exports provided: getImgFromUnsplash, makeCanvasGray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getImgFromUnsplash\", function() { return getImgFromUnsplash; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"makeCanvasGray\", function() { return makeCanvasGray; });\n/* eslint-disable no-param-reassign */\nasync function getLinkToImageAndSize() {\n  const town = document.querySelector('#selectedTownTxt').value || 'Minsk'; // берется город по умолчанию будет Минск\n\n  const url = `https://api.unsplash.com/photos/random?query=town,${town}&client_id=0befbf182316cad78146a16286e63afa84cf9a204c5af610d54d03ec16996f7a`;\n  const response = await fetch(url);\n  const data = await response.json();\n  return data;\n}\n\nfunction getImgFromUnsplash(img, ctx, canvas) {\n  document.querySelector('.load').addEventListener('click', () => {\n    getLinkToImageAndSize().then(data => {\n      // eslint-disable-next-line no-param-reassign\n      img.src = data.urls.full;\n      img.width = data.width;\n      img.height = data.height;\n      img.crossOrigin = 'anonymous';\n      const sign = Math.sign(img.width - img.height);\n      const w0 = img.width;\n      const h0 = img.height; // eslint-disable-next-line default-case\n\n      switch (sign) {\n        case 1:\n          {\n            img.width = 512;\n            img.height = h0 * 512 / w0;\n            break;\n          }\n\n        case -1:\n          {\n            img.height = 512;\n            img.width = w0 * 512 / h0;\n            break;\n          }\n      }\n    });\n\n    img.onload = () => {\n      ctx.drawImage(img, (canvas.width - img.width) / 2, (canvas.height - img.height) / 2, img.width, img.height);\n    };\n  });\n}\nfunction makeCanvasGray(img, ctx, canvas) {\n  document.querySelector('.grayscale').addEventListener('click', () => {\n    img.style.display = 'none';\n    const imageData = ctx.getImageData(0, 0, canvas.width, canvas.height);\n    const {\n      data\n    } = imageData;\n\n    for (let i = 0; i < data.length; i += 4) {\n      const avg = (data[i] + data[i + 1] + data[i + 2]) / 3;\n      data[i] = avg; // red\n\n      data[i + 1] = avg; // green\n\n      data[i + 2] = avg; // blue\n    }\n\n    ctx.putImageData(imageData, 0, 0);\n  });\n}\n\n//# sourceURL=webpack:///./src/js/unsplashAPI.js?");
